  ...
  <div>
    <el-form label-width="120px" v-for="service in config.services" :key="service">
      ...
      <el-form-item label="帐号">
        <el-input v-model="service.username" auto-complete="off" placeholder="输入帐号"></el-input>
      </el-form-item>
      <el-form-item label="密码">
        <el-input v-model="service.password" auto-complete="off" placeholder="输入密码"></el-input>
      </el-form-item>
